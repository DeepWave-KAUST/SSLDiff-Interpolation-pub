...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        self, model, x, shot_far, t, clip_denoised=True, denoised_fn=None, model_kwargs=None
    ):
        """
    ...
    def _vb_terms_bpd(
        ...
        out = self.p_mean_variance(
            model, x_t, shot_far, t, clip_denoised=clip_denoised, model_kwargs=model_kwargs
        )
    ...
    def training_losses(self, model, x_start, shot_far, t, model_kwargs=None, noise=None):
        """
    ...
    def calc_bpd_loop(self, model, x_start, shot_far, clip_denoised=True, model_kwargs=None):
        """
